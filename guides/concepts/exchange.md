...
In addition to supporting the issuing and movement of [assets](./assets.md), the Payshares network also acts as a decentralized **distributed exchange**
...
an existing offer, it is filled at the price of the existing offer. Let's say that you make an offer to buy 10 XPS for 2 BTC. If an offer already
exists to sell 10 XPS for 2 BTC, your offer will take that offer--you'll be 2 BTC poorer but 10 XPS richer.
...
Offers in Payshares behave like limit orders in traditional markets. 

For offers placed at the same price, the older offer is filled before the newer one.  

## Orderbook
An **orderbook** is a record of outstanding orders on the Payshares network. This record sits between any two assets--in this case,
...
For example, if the best offer to buy BTC for XPS has a price of 100XPS/BTC, and you make a passive offer to sell BTC at 100XPS/BTC, your passive offer *does not* take that existing offer.
If you instead make a passive offer to sell BTC at 99XPS/BTC it would cross the existing offer and fill at 100XPS/BTC.
...
Payshares that will automatically convert your sheep into wheat. It goes through the sheep/wheat orderbook and converts your sheep at the best available rate.
...
orderbooks and finding which series of conversions gives you the best rate. It is handled outside of Payshares Core by something like Horizon.


## Preferred currency
Because cross-asset payments are so simple with Payshares, users can keep their money in whatever asset they prefer to hold. **Preferred currency** creates a very flexible, open system. 
